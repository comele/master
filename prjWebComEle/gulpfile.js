...
var path = {
	...
	jspmPackagesDest: 'dist/jspm_packages'
};
...
taskMaker.defineTask('copy', {taskName: 'jspmPackages', src: path.jspmPackages, dest: path.jspmPackagesDest});
...
/**
 * Tarea que permite generar un archivo war
 */
gulp.task('deploy', function(callback) {
	...
	return runSequence('recompile', 'index.html', 'systemConfig', 'jspmPackages', function(callback){
		maven.config(deployConfig);
		console.log('Generando war');
		maven.package();
	});
});
